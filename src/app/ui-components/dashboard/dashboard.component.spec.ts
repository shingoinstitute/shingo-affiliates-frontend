...
describe('DashboardComponent', () => {
  ...
  it('should have a quick details component', () => {
    expect(fixture.debugElement.query(By.css('app-quick-details'))).toBeDefined();
  });

  it('should have a upcoming workshops component', () => {
    expect(fixture.debugElement.query(By.css('app-upcoming-workshops'))).toBeDefined();
  });

  it('should have an action pending component', () => {
    expect(fixture.debugElement.query(By.css('app-action-pending'))).toBeDefined();
  });
