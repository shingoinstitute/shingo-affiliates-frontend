...
export class FacilitatorFormComponent
      ...
      (facilitator: Facilitator) => {
        ...
        if (facilitator) {
          ...
          this.formGroup.controls.email.patchValue({
            sfObject: this.facilitator,
          })
          this.formGroup.controls.affiliate.patchValue({
            sfObject: this.facilitator.affiliate,
          })
  ...
  public create() {
    ...
    this._fs.create(this.facilitator).subscribe(
      ...
      err => {
        ...
        this.isLoading = false
        this.snackbar.open(
          'Failed to create new facilitator. Make sure you are not trying to create a duplicate facilitator.',
          'Okay',
        )
      },
    )
  ...
  public handleError(err: any) {
    ...
    this.snackbar.open(
      'An error occured and the requested operation could not be complete.',
      'Okay',
    )
  }
  ...
  public checkForAffiliate() {
    try {
      this.facilitator.affiliate.sfId === ''
        ? this.disabledRoleField()
        : this.enableRoleField()
    } catch (e) {
      this.disabledRoleField()
    }
  }
