...
import {
  MockWorkshopService,
  EXPECTED_WORKSHOPS,
} from '../../../services/workshop/workshop.service.mock'
import { Affiliate } from '../../../affiliates/affiliate.model'
import { AffiliateService } from '../../../services/affiliate/affiliate.service'
import {
  MockAffiliateService,
  EXPECTED_AFFILIATES,
  EXPECTED_COURSE_MANAGERS,
} from '../../../services/affiliate/affiliate.service.mock'
import { Facilitator } from '../../../facilitators/facilitator.model'
import { FacilitatorService } from '../../../services/facilitator/facilitator.service'
import {
  MockFacilitatorService,
  EXPECTED_FACILITATORS,
} from '../../../services/facilitator/facilitator.service.mock'
      ...
      providers: [
        {
          ...
          useFactory: () => instance(MockWorkshopService),
        },
        {
          provide: AffiliateService,
          useFactory: () => instance(MockAffiliateService),
        },
        {
          provide: FacilitatorService,
          useFactory: () => instance(MockFacilitatorService),
        },
        FormBuilder,
      ],
    }).compileComponents()
