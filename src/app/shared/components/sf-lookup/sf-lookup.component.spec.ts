...
import { MockAffiliateService, EXPECTED_AFFILIATES } from '../../../services/affiliate/affiliate.service.mock';
...
describe('SfLookupComponent', () => {
  ...
  describe('handleQuery', () => {
    ...
    it('should throw when handleQuery is called without an initialized sfObject', () => {
      expect(() => component.handleQuery('some query')).toThrow(new Error(`Cannot determine a search function for ${typeof component.sfObject}`));
    });
