...
describe('WorkshopDateRangeFilter', () => {
  ...
  it(`expects filtered workshops' start dates to be >= '1/1/2000'`, () => {  
    ...
    expect(filteredWorkshops[0].startDate.valueOf()).toBeGreaterThanOrEqual(new Date('1/2/2000').valueOf());
    expect(filteredWorkshops[1].startDate.valueOf()).toBeGreaterThanOrEqual(new Date('1/2/2000').valueOf());
    expect(filteredWorkshops[2].startDate.valueOf()).toBeGreaterThanOrEqual(new Date('1/2/2000').valueOf());
  });
  ...
  it(`expects filtered workshops' start dates to be < '1/2/2000'`, () => {  
    ...
    expect(filteredWorkshops[0].startDate.valueOf()).toBeLessThan(new Date('1/3/2000').valueOf());
    expect(filteredWorkshops[1].startDate.valueOf()).toBeLessThan(new Date('1/3/2000').valueOf());
  });
